...
def print_cb(word, word_eol, event, attr):
    ...
    edited = True
    hexchat.emit_print(event, "\003"+returnHex(nick)+nick, msg)
    edited = False
...
hexchat.hook_print("Private Message to Dialog", print_cb)
hexchat.hook_print("Private Action to Dialog", print_cb)
